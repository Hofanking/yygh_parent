package com.scorpios.yygh.user.controller.api;

import com.alibaba.fastjson.JSONObject;
import com.scorpios.yygh.common.exception.YyghException;
import com.scorpios.yygh.common.helper.JwtHelper;
...
import com.scorpios.yygh.user.util.ConstantPropertiesUtil;
import com.scorpios.yygh.user.util.HttpClientUtils;
...
public class WeixinApiController {
    ...
    /**
     *  微信扫码登录流程：
     *      1、页面点击微信授权的按钮，调用后台服务接口，返回页面生成二维码需要的参数
     *      2、用户用微信扫二维码之后，点击确认后，微信后台服务会回调我们服务的接口地址，并返回code和state
     */
     ...
     *      3、使用access_token和openid换取受保护的资源：微信的个人信息
     * @param code
     * @param state
     * @return
     */
    ...
    public String callback(String code, String state) {
        ...
        if(null == userInfo){
            //如果查询到个人信息，那么直接进行登录
            //使用access_token和openid换取受保护的资源：微信的个人信息
